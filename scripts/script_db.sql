...
CREATE TABLE Repuestos (
  ...
  descripcionRepuesto VARCHAR (100),
  stockRepuesto INT,
...
CREATE TABLE CaracteristicasVehiculo(
	...
	potencia VARCHAR(50),
	frenosDelanteros VARCHAR(50),
	transmision VARCHAR(50),
	frenosTraseros VARCHAR(50),
	torqueMaximo VARCHAR(50),
	volumenDeBaul VARCHAR(50),
	nroDePuertas VARCHAR(50),
	precio VARCHAR(20),
