...
public class FormNuevosRepuestos extends JDialog {
	...
	public void cargarTabla(List<RepuestoDTO> repuestos) {
		for (RepuestoDTO repuesto : repuestos) {
			Object[] row = { repuesto.getCodigoRepuesto().toString(), repuesto.getDescripcionRepuesto(),
					repuesto.getMarcaRepuesto(), repuesto.getFabricante(), repuesto.getStockRepuesto(),
