...
public class PanelGestionTrabajoView extends JPanel {
	...
	private static PanelGestionTrabajoView instance;
	...
	public static PanelGestionTrabajoView getInstance() {
		if (instance == null) {
			instance = new PanelGestionTrabajoView();
		}
		return instance;
	}

	private PanelGestionTrabajoView() {
