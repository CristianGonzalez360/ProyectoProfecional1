...
public class CarritoRepuestosFormView extends JDialog {
	...
	static CarritoRepuestosFormView vista;
	...
	public static CarritoRepuestosFormView getInstance() {
		if (vista == null)
			vista = new CarritoRepuestosFormView();
		return vista;
	}

	@SuppressWarnings("serial")
	private CarritoRepuestosFormView() {
		setModal(true);
