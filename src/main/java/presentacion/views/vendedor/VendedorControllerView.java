...
public class VendedorControllerView extends JInternalFrame {
	...
	private static VendedorControllerView instance;
	...
	public static VendedorControllerView getInstance() {
		if (instance == null)
			instance = new VendedorControllerView();
		return instance;
	}

	private VendedorControllerView() {
