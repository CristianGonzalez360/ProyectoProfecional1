...
public class ClientePresenter {
	...
	public ClientePresenter(PanelClientesView view, ClientesController controller,
			VehiculosController vehiculoController) {
		this.view = view;
	...
	private void onBuscar(ActionEvent a) {
		...
		List<String> errors = new StringValidator(inputDni)
				.regex("El dni debe ser un numero de dni", Patterns.NON_NEGATIVE_INTEGER_FIELD).validate();
		if (errors.isEmpty()) {
