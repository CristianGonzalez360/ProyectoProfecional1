...
public class ConsultaDePresupuestoPresenter {
	...
	public ConsultaDePresupuestoPresenter(VehiculosConOrdenDeTrabajoController controller,
			ClientesController clienteController, OrdenesTrabajoController otController,
			PresupuestosController presController, FacturasController facController) {
	...
	private void onSelectPresupuesto() {
		...
		if (presupuesto != null) {
			List<TrabajoPresupuestadoDTO> trabajos = presController
					.readTrabajosByIdPresupuesto(presupuesto.getIdPresupuesto());
			view.clearDataTrabajos();
			view.setDataTrabajos(trabajos);
			List<RepuestoPlanificadoDTO> repuestos = presController
					.readRepuestoByIdPresupuesto(presupuesto.getIdPresupuesto());
